...
* (Scriptnya AJHIALFARIDHO).
*/
const BotName = 'AditGans'; // Nama Bot Whatsapp
...
conn.sendMessage(id, 'Owner AditGans http://Wa.me/+62895619811574' ,MessageType.text);
}
else if (text == 'AditGans'){
...
//Tolonglah bro jangan di ubah ubah scripnya ya kecuali di bangian titik untuk memanggil si program contoh !menu/\ itu bisa di ganti ya
